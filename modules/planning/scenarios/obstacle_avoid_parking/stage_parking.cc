#include "modules/planning/scenarios/obstacle_avoid_parking/stage_parking.h"
...
StageResult StageParking::Process(const common::TrajectoryPoint& planning_init_point, Frame* frame) {
    AERROR << "1";
